function result = gofPIOSRn(copula, x, options)
%GOFPIOSRN Copula goodness-of-fit test with parametric bootstrap.
arguments
...
result = gofcopula.runTest("gofPIOSRn",copula,x,args{:});
end
