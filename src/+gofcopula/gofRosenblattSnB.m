function result = gofRosenblattSnB(copula, x, options)
%GOFROSENBLATTSNB Copula goodness-of-fit test with parametric bootstrap.
arguments
...
result = gofcopula.runTest("gofRosenblattSnB",copula,x,args{:});
end
