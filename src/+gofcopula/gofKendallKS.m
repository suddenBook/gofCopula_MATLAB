function result = gofKendallKS(copula, x, options)
%GOFKENDALLKS Copula goodness-of-fit test with parametric bootstrap.
arguments
...
result = gofcopula.runTest("gofKendallKS",copula,x,args{:});
end
