function result = gofRosenblattSnC(copula, x, options)
%GOFROSENBLATTSNC Copula goodness-of-fit test with parametric bootstrap.
arguments
...
result = gofcopula.runTest("gofRosenblattSnC",copula,x,args{:});
end
