function result = gofKendallCvM(copula, x, options)
%GOFKENDALLCVM Copula goodness-of-fit test with parametric bootstrap.
arguments
...
result = gofcopula.runTest("gofKendallCvM",copula,x,args{:});
end
