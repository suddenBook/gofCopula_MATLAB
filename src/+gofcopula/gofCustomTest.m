function result = gofCustomTest(copula, x, options)
%GOFCUSTOMTEST Copula goodness-of-fit test with parametric bootstrap.
arguments
...
result = gofcopula.runTest("gofCustomTest",copula,x,args{:});
end
