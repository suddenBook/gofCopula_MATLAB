function result = gofArchmChisq(copula, x, options)
%GOFARCHMCHISQ Copula goodness-of-fit test with parametric bootstrap.
arguments
...
result = gofcopula.runTest("gofArchmChisq",copula,x,args{:});
end
