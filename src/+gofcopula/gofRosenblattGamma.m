function result = gofRosenblattGamma(copula, x, options)
%GOFROSENBLATTGAMMA Copula goodness-of-fit test with parametric bootstrap.
arguments
...
result = gofcopula.runTest("gofRosenblattGamma",copula,x,args{:});
end
