function result = gofRosenblattChisq(copula, x, options)
%GOFROSENBLATTCHISQ Copula goodness-of-fit test with parametric bootstrap.
arguments
...
result = gofcopula.runTest("gofRosenblattChisq",copula,x,args{:});
end
