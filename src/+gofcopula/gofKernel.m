function result = gofKernel(copula, x, options)
%GOFKERNEL Copula goodness-of-fit test with parametric bootstrap.
arguments
...
result = gofcopula.runTest("gofKernel",copula,x,args{:});
end
