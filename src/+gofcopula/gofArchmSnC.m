function result = gofArchmSnC(copula, x, options)
%GOFARCHMSNC Copula goodness-of-fit test with parametric bootstrap.
arguments
...
result = gofcopula.runTest("gofArchmSnC",copula,x,args{:});
end
